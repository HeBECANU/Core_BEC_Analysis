...
est_fun = @(c) corr_wrap(corr_func,c,corr_opts);
...
ci = bootci(corr_opts.num_samp_rep,est_fun,counts);
...
function out = corr_wrap(corr_func,counts,corr_opts) %corr_wrap(corr_func,counts,atten,corr_opts)
corr_opts.attenuate_counts = 1.0;
